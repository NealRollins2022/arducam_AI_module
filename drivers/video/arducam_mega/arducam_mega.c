/* 
 * NOTE: This file was auto-transformed to the new Zephyr video controls API (V4L2-style).
 * Mappings applied to VIDEO_CID_* IDs, and includes updated to <zephyr/video/...> paths.
 * Review TODOs and compile with NCS (nrf5340dk_nrf5340_cpuapp_ns).
 */
/**
...
static inline void arducam_cs_assert(void) {
    gpio_pin_set_dt(&arducam_cs, 0);
}

static inline void arducam_cs_deassert(void) {
